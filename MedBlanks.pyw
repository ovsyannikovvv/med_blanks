...
blanks_lst = [
    ...
    [1, [u"АНАЛИЗ КРОВИ", u"ОБЩИЙ", u"СОЭ", u"лейкоциты", u"Hb", u"ретикулоциты", u"базофильная зернистость"]],
    ...
    [2, [u"ОБЩИЙ БЕЛОК\n+ БЕЛКОВЫЕ ФРАКЦИИ"]],
    [2, [u"БИОХИМИЧЕСКИЙ АНАЛИЗ КРОВИ", u"ОБЩИЙ БЕЛОК", u"АМИЛАЗА", u"БИЛИРУБИН", u"САХАР", u"ХОЛЕСТЕРИН",
        u"ЩЕЛОЧНАЯ ФОСФОТАЗА", u"МОЧЕВИНА", u"МОЧЕВАЯ КИСЛОТА", u"FE-СЫВОРОТКА", u"КРЕАТИНИН",
    ...
    [3, [u"РЕНТГЕНОГРАФИЯ", u"Грудной клетки в 2х проекциях", u"Правого коленного сустава",
        ...
        u"Поясничного отдела позвоночника"]]
]
